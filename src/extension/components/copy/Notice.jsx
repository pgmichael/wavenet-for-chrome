...
export const Notice = () => (
  <div className='flex flex-col gap-3'>
    ...
    <p>
      If you have already purchased credits, but are seeing this message click here to <span className='cursor-pointer text-blue-700 font-semibold underline' onClick={() => chrome.runtime.sendMessage({id: 'authenticate'})}>re-sync your account</span>.
    </p>
  </div>
)
